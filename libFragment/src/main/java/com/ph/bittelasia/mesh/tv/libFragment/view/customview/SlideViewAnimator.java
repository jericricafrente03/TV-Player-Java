...
public class SlideViewAnimator extends ViewAnimator {
    ...
    public SlideViewAnimator(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SlideViewAnimator(Context context) {
        super(context);
    }
